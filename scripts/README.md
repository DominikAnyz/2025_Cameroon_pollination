...
## 03.Setup_for_pollination_indices

The script contains the data setup for the following script, to create
datasets to be used in the models

## 04.GLMM_pollination_indices
...
## 05.Setup_for_visitation_indices
...
## 07.Setup_for_index_comparisons
