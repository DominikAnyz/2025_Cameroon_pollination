...
###*
###* - not rescaled
###* --- without mean_seedset = 0 ---> c.pl.final.table
...
###* --- without mean_seedset = 0 ---> c.pl.final.table
###* ----- formula <- bf(log_mean_seedset | se(se_log_mean_seedset) ~ me(mean.visitors.scaled, sd.visitors.sclaed) + (1|species) + (1|elevation))
###* --- with mean seedset = 0 will use poisson and rounded seedset) ---> c.pl.final.table.2
...
###* --- without mean_seedset = 0 ---> c.pl.final.table
###* ----- formula <- bf(log_mean_seedset | se(se_log_mean_seedset) ~ me(log.m.s.p.o, log.s.s.p.o) + (1|species) + (1|elevation))
###* --- with mean seedset = 0 (will use poisson and rounded seedset) ---> c.pl.final.table.2
...
saveRDS(fit_seedset_nr_0, file = "../brms_models/fit_seedset_nr_0.rds")
fit_seedset_nr_0 <- readRDS("../brms_models/fit_seedset_nr_0.rds")
summary(fit_seedset_nr_0)
pp_check(fit_seedset_nr_0)
bayes_R2(fit_seedset_nr_0)
plot(fit_seedset_nr_0)
fitted_values <- fitted(fit_seedset_nr_0)
residuals <- residuals(fit_seedset_nr_0)
...
# ###* - rescaled with scale function (scale)
# ###* --- without mean_seedset = 0 ---> c.pl.final.table
# formula <- bf(log_mean_seedset | se(se_log_mean_seedset) ~ me(mean.visitors.scaled, sd.visitors.scaled) + (1|species) + (1|elevation))
# ###* Setting priors
# prior <- c(set_prior("normal(0, 2.5)", class = "b"), set_prior("student_t(3, 0, 5)", class = "sd", group = "elevation"), set_prior("student_t(3, 0, 5)", class = "sd", group = "species"))
# 
# fit_seedset_r_0 <- brm(
...
#   seed = 1234 # Addition to code
# )
# summary(fit_seedset_r_0)
# saveRDS(fit_seedset_r_0, file = "../brms_models/fit_seedset_r_0.rds")
# fit_seedset_r_0 <- readRDS("../brms_models/fit_seedset_r_0.rds")
###* RHAT problem
###*
###*
###*
...
#   seed = 1234 # Addition to code
# )
# summary(fit_seedset_r2_0)
# saveRDS(fit_seedset_r2_0, file = "../brms_models/fit_seedset_r2_0.rds")
# fit_seedset_r2_0 <- readRDS("../brms_models/fit_seedset_r2_0.rds")
###* RHAT problem
###*
###*
###*
...
saveRDS(fit_seedset_r2_p, file = "../brms_models/fit_seedset_r2_p.rds")
fit_seedset_r2_p <- readRDS("../brms_models/fit_seedset_r2_p.rds")
summary(fit_seedset_r2_p)
pp_check(fit_seedset_r2_p)
bayes_R2(fit_seedset_r2_p)
plot(fit_seedset_r2_p)
fitted_values <- fitted(fit_seedset_r2_p)
residuals <- residuals(fit_seedset_r2_p)
plot(fitted_values, residuals)
abline(h = 0, col = "red")
###* 
###* 
...
###* - not rescaled
###* --- without mean_seedset = 0 ---> c.pl.final.table
formula <- bf(log_mean_seedset | se(se_log_mean_seedset) ~ log_visitors + (1|species) + (1|elevation))
...
saveRDS(fit_seedset_nr_0_partial, file = "../brms_models/fit_seedset_nr_0_partial.rds")
fit_seedset_nr_0_partial <- readRDS("../brms_models/fit_seedset_nr_0_partial.rds")
summary(fit_seedset_nr_0_partial)
pp_check(fit_seedset_nr_0_partial)
bayes_R2(fit_seedset_nr_0_partial)
plot(fit_seedset_nr_0_partial)
fitted_values <- fitted(fit_seedset_nr_0_partial)
residuals <- residuals(fit_seedset_nr_0_partial)
plot(fitted_values, residuals)
abline(h = 0, col = "red")
###*
###*
...
saveRDS(fit_seedset_nr_p_partial, file = "../brms_models/fit_seedset_nr_p_partial.rds")
fit_seedset_nr_p_partial <- readRDS("../brms_models/fit_seedset_nr_p_partial.rds")
summary(fit_seedset_nr_p_partial)
pp_check(fit_seedset_nr_0_partial)
bayes_R2(fit_seedset_nr_0_partial)
plot(fit_seedset_nr_0_partial)
fitted_values <- fitted(fit_seedset_nr_0_partial)
...
###* - rescaled with scale function (scale)
###* --- without mean_seedset = 0 ---> c.pl.final.table
formula <- bf(log_mean_seedset | se(se_log_mean_seedset) ~ mean.visitors.scaled + (1|species) + (1|elevation))
###* Setting priors
prior <- c(set_prior("normal(0, 2.5)", class = "b"), set_prior("student_t(3, 0, 5)", class = "sd", group = "elevation"), set_prior("student_t(3, 0, 5)", class = "sd", group = "species"))

fit_seedset_r_0_partial <- brm(
  formula = formula,
  data = c.pl.final.table,
  chains = 10,
  cores = 10,
...
saveRDS(fit_seedset_r_0_partial, file = "../brms_models/fit_seedset_r_0_partial.rds")
fit_seedset_r_0_partial <- readRDS("../brms_models/fit_seedset_r_0_partial.rds")
summary(fit_seedset_r_0_partial)
pp_check(fit_seedset_r_0_partial)
bayes_R2(fit_seedset_r_0_partial)
plot(fit_seedset_r_0_partial)
fitted_values <- fitted(fit_seedset_r_0_partial)
residuals <- residuals(fit_seedset_r_0_partial)
plot(fitted_values, residuals)
abline(h = 0, col = "red")
###*
###*
...
saveRDS(fit_seedset_r_p_partial, file = "../brms_models/fit_seedset_r_p_partial.rds")
fit_seedset_r_p_partial <- readRDS("../brms_models/fit_seedset_r_p_partial.rds")
summary(fit_seedset_r_p_partial)
pp_check(fit_seedset_r_p_partial)
bayes_R2(fit_seedset_r_p_partial)
plot(fit_seedset_r_p_partial)
fitted_values <- fitted(fit_seedset_r_p_partial)
residuals <- residuals(fit_seedset_r_p_partial)
plot(fitted_values, residuals)
abline(h = 0, col = "red")
###*
###*
...
###* - rescaled with scale function (log + 1)
###* --- without mean_seedset = 0 ---> c.pl.final.table
formula <- bf(log_mean_seedset | se(se_log_mean_seedset) ~ log.m.s.p.o + (1|species) + (1|elevation))
###* Setting priors
prior <- c(set_prior("normal(0, 2.5)", class = "b"), set_prior("student_t(3, 0, 5)", class = "sd", group = "elevation"), set_prior("student_t(3, 0, 5)", class = "sd", group = "species"))

fit_seedset_r2_0_partial <- brm(
  formula = formula,
  data = c.pl.final.table,
  chains = 10,
  cores = 10,
...
saveRDS(fit_seedset_r2_0_partial, file = "../brms_models/fit_seedset_r2_0_partial.rds")
fit_seedset_r2_0_partial <- readRDS("../brms_models/fit_seedset_r2_0_partial.rds")
summary(fit_seedset_r2_0_partial)
pp_check(fit_seedset_r2_0_partial)
bayes_R2(fit_seedset_r2_0_partial)
plot(fit_seedset_r2_0_partial)
fitted_values <- fitted(fit_seedset_r2_0_partial)
residuals <- residuals(fit_seedset_r2_0_partial)
plot(fitted_values, residuals)
abline(h = 0, col = "red")
###*
###*
...
saveRDS(fit_seedset_r2_p_partial, file = "../brms_models/fit_seedset_r2_p_partial.rds")
fit_seedset_r2_p_partial <- readRDS("../brms_models/fit_seedset_r2_p_partial.rds")
summary(fit_seedset_r2_p_partial)
pp_check(fit_seedset_r2_p_partial)
