...
###* AUTOGAMY
###* POLLEN LIMITATION
kfold_ao_13 <- readRDS("../brms_models/kfold_bayesian_pl_mean_corrected_scaled_13_zoib_k_opt_2.rds")
kfold_ao_null <- readRDS("../brms_models/kfold_bayesian_pl_mean_corrected_scaled_null_zoib_k_opt_2.rds")
kfold_ao_135 <- readRDS("../brms_models/kfold_bayesian_pl_mean_corrected_scaled_135_zoib_k_opt_2.rds")
kfold_ao_1 <- readRDS("../brms_models/kfold_bayesian_pl_mean_corrected_scaled_1_zoib_k_opt_2.rds")
kfold_ao_3 <- readRDS("../brms_models/kfold_bayesian_pl_mean_corrected_scaled_3_zoib_k_opt_2.rds")
kfold_ao_5 <- readRDS("../brms_models/kfold_bayesian_pl_mean_corrected_scaled_5_zoib_k_opt_2.rds")
kfold_ao_35 <- readRDS("../brms_models/kfold_bayesian_pl_mean_corrected_scaled_35_zoib_k_opt_2.rds")
kfold_ao_15 <- readRDS("../brms_models/kfold_bayesian_pl_mean_corrected_scaled_15_zoib_k_opt_2.rds")
