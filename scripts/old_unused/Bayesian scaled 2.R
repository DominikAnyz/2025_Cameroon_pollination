...
###* ----- use actual values in visitation
formula <- bf(mean_PL_index | weights(n_replicates) ~ me(mean.visitors.per.minute, sd.visitors.per.minute) + (1|species) + (1|elevation)
)
fit_PL_nr_y_o_n <- brm(
  formula = formula,
  data = c.pl.final.table.2,
...
saveRDS(fit_PL_nr_y_o_n, file = "../brms_models/fit_PL_nr_y_o_n.rds")
fit_PL_nr_y_o_n <- readRDS("../brms_models/fit_PL_nr_y_o_n.rds")
summary(fit_PL_nr_y_o_n)
pp_check(fit_PL_nr_y_o_n, type = "dens_overlay")
pp_check(fit_PL_nr_y_o_n, type = "stat")
bayes_R2(fit_PL_nr_y_o_n)
plot(fit_PL_nr_y_o_n)
fitted_values <- fitted(fit_PL_nr_y_o_n)
residuals <- residuals(fit_PL_nr_y_o_n)
plot(fitted_values, residuals)
abline(h = 0, col = "red")
###*
###*
...
formula <- bf(mean_PL_index | weights(n_replicates) ~ me(log_visitors, sd_log_visitors) + (1|species) + (1|elevation)
)
...
saveRDS(fit_PL_nr_y_l_n, file = "../brms_models/fit_PL_nr_y_l_n.rds")
fit_PL_nr_y_l_n <- readRDS("../brms_models/fit_PL_nr_y_l_n.rds")
summary(fit_PL_nr_1_l_n)
pp_check(fit_PL_nr_1_l_n, type = "dens_overlay")
pp_check(fit_PL_nr_1_l_n, type = "stat")
bayes_R2(fit_PL_nr_1_l_n)
plot(fit_PL_nr_1_l_n)
fitted_values <- fitted(fit_PL_nr_1_l_n)
residuals <- residuals(fit_PL_nr_1_l_n)
plot(fitted_values, residuals)
abline(h = 0, col = "red")
###* 
###* 
...
###* - rescaled with scale function (scale)
###* --- with mean_PL_index = 1 (will use zero-one-inflated-beta) ---> c.pl.final.table.2
formula <- bf(mean_PL_index | weights(n_replicates) ~ me(mean.visitors.scaled, sd.visitors.scaled) + (1|species) + (1|elevation))
...
saveRDS(fit_PL_r_y_n, file = "../brms_models/fit_PL_r_y_n.rds")
fit_PL_r_y_n <- readRDS("../brms_models/fit_PL_r_y_n.rds")
summary(fit_PL_r_y_n)
pp_check(fit_PL_r_y_n, type = "dens_overlay")
pp_check(fit_PL_r_y_n, type = "stat")
bayes_R2(fit_PL_r_y_n)
plot(fit_PL_r_y_n)
fitted_values <- fitted(fit_PL_r_y_n)
residuals <- residuals(fit_PL_r_y_n)
plot(fitted_values, residuals)
abline(h = 0, col = "red")
###* 
###* 
...
saveRDS(fit_PL_r2_y_n, file = "../brms_models/fit_PL_r2_y_n.rds")
fit_PL_r2_y_n <- readRDS("../brms_models/fit_PL_r2_y_n.rds")
summary(fit_PL_r2_y_n)
pp_check(fit_PL_r2_y_n, type = "dens_overlay")
pp_check(fit_PL_r2_y_n, type = "stat")
bayes_R2(fit_PL_r2_y_n)
plot(fit_PL_r2_y_n)
fitted_values <- fitted(fit_PL_r2_y_n)
residuals <- residuals(fit_PL_r2_y_n)
plot(fitted_values, residuals)
abline(h = 0, col = "red")
###* 
###* 
...
saveRDS(fit_PL_nr_y_o_partial_n, file = "../brms_models/fit_PL_nr_y_o_partial_n.rds")
#fit_PL_nr_y_o_partial_n <- readRDS("../brms_models/fit_PL_nr_y_o_partial_n.rds")
summary(fit_PL_nr_y_o_partial_n)
###*
###*
###*
###*
...
saveRDS(fit_PL_nr_y_l_partial_n, file = "../brms_models/fit_PL_nr_y_l_partial_n.rds")
#fit_PL_nr_y_l_partial_n <- readRDS("../brms_models/fit_PL_nr_y_l_partial_n.rds")
summary(fit_PL_nr_y_l_partial_n)
###* 
###* 
###* 
###* 
...
###* - rescaled with scale function (scale)
###* --- without mean_PL_index = 1 ---> c.pl.final.table
# formula <- bf(mean_PL_index | weights(n_replicates) ~ mean.visitors.scaled + (1|species) + (1|elevation))
# 
...
###* - rescaled with scale function (log + 1)
###* --- without mean_PL_index = 1 ---> c.pl.final.table
formula <- bf(mean_PL_index | weights(n_replicates) ~ log.m.s.p.o + (1|species) + (1|elevation))

fit_PL_r2_1_partial_n <- brm(
  formula = formula,
  data = c.pl.final.table,
  family = Beta(),
  prior = c(
...
summary(fit_PL_r2_1_partial_n)
saveRDS(fit_PL_r2_1_partial_n, file = "../brms_models/fit_PL_r2_1_partial_n.rds")
#fit_PL_r2_1_partial_n <- readRDS("../brms_models/fit_PL_r2_1_partial_n.rds")
###*
###*
###* - rescaled with scale function (log + 1)
###* --- with mean_PL_index = 1 (will be changed to 0.9999) ---> c.pl.final.table.2
...
saveRDS(fit_PL_r2_y_partial_n, file = "../brms_models/fit_PL_r2_y_partial_n.rds")
#fit_PL_r2_y_partial_n <- readRDS("../brms_models/fit_PL_r2_y_partial_n.rds")
summary(fit_PL_r2_y_partial_n)
###* 
###* 
###* 
###* 
...
saveRDS(fit_ao_nr_0_n, file = "../brms_models/fit_ao_nr_0_n.rds")
#fit_ao_nr_0_n <- readRDS("../brms_models/fit_ao_nr_0_n.rds")
###*
###*
###*
###*
...
saveRDS(fit_ao_nr_l_n, file = "../brms_models/fit_ao_nr_l_n.rds")
#fit_ao_nr_l_n <- readRDS("../brms_models/fit_ao_nr_l_n.rds")
###*
###*
###*
###*
...
saveRDS(fit_ao_r_o_n, file = "../brms_models/fit_ao_r_o_n.rds")
#fit_ao_r_o_n <- readRDS("../brms_models/fit_ao_r_o_n.rds")
###*
###*
###*
###*
...
saveRDS(fit_ao_r2_o_n, file = "../brms_models/fit_ao_r2_o_n.rds")
#fit_ao_r2_o_n <- readRDS("../brms_models/fit_ao_r2_o_n.rds")
summary(fit_ao_r2_o_n)
###*
###*
###*
###*
...
saveRDS(fit_ao_nr_0_partial_n, file = "../brms_models/fit_ao_nr_0_partial_n.rds")
#fit_ao_nr_0_partial_n <- readRDS("../brms_models/fit_ao_nr_0_partial_n.rds")
summary(fit_ao_nr_0_partial_n)
...
saveRDS(fit_ao_nr_l_partial_n, file = "../brms_models/fit_ao_nr_l_partial_n.rds")
#fit_ao_nr_l_partial_n <- readRDS("../brms_models/fit_ao_nr_l_partial_n.rds")
summary(fit_ao_nr_l_partial_n)
###*
###*
###*
###*
...
saveRDS(fit_ao_r_o_partial_n, file = "../brms_models/fit_ao_r_o_partial_n.rds")
#fit_ao_r_o_partial_n <- readRDS("../brms_models/fit_ao_r_o_partial_n.rds")
summary(fit_ao_r_o_partial_n)
###*
###*
###*
###*
...
saveRDS(fit_ao_r2_o_partial_n, file = "../brms_models/fit_ao_r2_o_partial_n.rds")
#fit_ao_r2_o_partial_n <- readRDS("../brms_models/fit_ao_r2_o_partial_n.rds")
summary(fit_ao_r2_o_partial_n)
###*
###*
###*
###*
...
###* --- with mean_go_index = 0 and 1 (will use zero-one-inflated-beta) 
###* ----- use actual values in visitation
formula <- bf(mean_go_index | weights(n_replicates) ~ me(mean.visitors.per.minute, sd.visitors.per.minute) + (1|species) + (1|elevation))
...
saveRDS(fit_go_nr_0_n, file = "../brms_models/fit_go_nr_0_n.rds")
#fit_go_nr_0_n <- readRDS("../brms_models/fit_go_nr_0_n.rds")
###*
###*
###*
###*
...
###* --- with mean_go_index = 0 and 1 (will use zero-one-inflated-beta)
###* ----- use logged values in visitation 
formula <- bf(mean_go_index | weights(n_replicates) ~ me(log_visitors, sd_log_visitors) + (1|species) + (1|elevation))
...
saveRDS(fit_go_nr_l_n, file = "../brms_models/fit_go_nr_l_n.rds")
#fit_go_nr_l_n <- readRDS("../brms_models/fit_go_nr_l_n.rds")
###*
###*
###*
###*
...
###* - rescaled with scale function (scale)
###* --- with mean_go_index = 0 and 1(will use zero-one-inflated-beta) 
formula <- bf(mean_go_index | weights(n_replicates) ~ me(mean.visitors.scaled, sd.visitors.scaled) + (1|species) + (1|elevation))
...
saveRDS(fit_go_r_o_n, file = "../brms_models/fit_go_r_o_n.rds")
#fit_go_r_o_n <- readRDS("../brms_models/fit_go_r_o_n.rds")
###*
###*
###*
###*
...
###* - rescaled with scale function (log + 1)
###* --- with mean_go_index = 0 and 1 (will use zero-one-inflated-beta)
formula <- bf(mean_go_index | weights(n_replicates) ~ me(log.m.s.p.o, log.s.s.p.o) + (1|species) + (1|elevation))
...
saveRDS(fit_go_r2_o_n, file = "../brms_models/fit_go_r2_o_n.rds")
#fit_go_r2_o_n <- readRDS("../brms_models/fit_go_r2_o_n.rds")
###*
###*
###*
###*
